...
const botDP="https://picsum.photos/200/300";
export const Signup = () => {
  ...
  async function uploadImage() {
    ...
    data.append("upload_preset", "alpanase");
    try {
      setUploadingImg(true);
      let res = await fetch("https://api.cloudinary.com/v1_1/drlfsdryg/image/upload", {
          method: "post",
          body: data,
      });
 ...
 async function handleSignup(e){
  ...
  return (
    ...
    <div className="signup-profile-pic__container">
                            <img src={imagePreview || botDP} className="signup-profile-pic" alt="dp-image"/>
