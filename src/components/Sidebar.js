                ...
                >
                    <Row>
                        <Col xs={2} className="member-status">
                            <img src={member.picture} className="member-status-img" alt='member-image' />
                            {member.status === "online" ?<FaLemon className="sidebar-online-status"/>:
                            <FaLemon className="sidebar-offline-status"/> }
                        </Col>
                        <Col xs={9}>
                            {member.name}
